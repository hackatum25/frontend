...
import org.example.project.generated.navbar_influence
import org.example.project.generated.navbar_post_details
import org.example.project.generated.navbar_profile
import org.example.project.generated.nest_eco_leaf_24px
...
sealed class NavItem(
    ...
    object CreatePost : NavItem("createPost", Res.string.navbar_create_post, Res.drawable.send_24px)
        object Influence : NavItem("influence", Res.string.navbar_influence, Res.drawable.nest_eco_leaf_24px)
    object Details : NavItem("postDetails", Res.string.navbar_post_details, Res.drawable.send_24px)

    companion object {
        private val map = listOf(Home, Profile, CreatePost, Details, Influence).associateBy { it.route }
